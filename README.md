...
> Build a consumer meal-prep planner that turns a weekly grocery and cooking inspiration video into a prep schedule, groce

---

## Overview

Users need a clearer way to act on meal prep and grocery planning assistant without starting from a blank product spec.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/meal-prep-atlas
      branch: master
